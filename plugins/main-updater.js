...
cmd({
    ...
    try {
        ...
        if (latestCommitHash === currentHash) {
            return reply("✅ Your DRACULA bot is already up-to-date!");
        }

        await reply("🚀 Updating DRACULA-MD...");

        // Download the latest code
        const zipPath = path.join(__dirname, "latest.zip");
        const { data: zipData } = await axios.get("https://github.com/DRACULA-MD/DRACULA-MD/archive/main.zip", { responseType: "arraybuffer" });
        ...
        const sourcePath = path.join(extractPath, "DRACULAMD-main");
